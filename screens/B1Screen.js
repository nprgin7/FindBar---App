...
export default class B1Screen extends React.Component {
    ...
    render() {  
        return (
            ...
            <SafeAreaView style={styles.container}>
              <ScrollView>
                  <Text style = {styles.ime}> Soho bar </Text>
                  <Text style = {styles.podnaslov}> restoran ・ bar </Text>
                 <ScrollView style={styles.bot} horizontal={true}>
                 <TouchableOpacity><Image style={styles.logo} source={require('./Images/s1.jpg')}/></TouchableOpacity>
                 <TouchableOpacity><Image style={styles.logo} source={require('./Images/s2.jpg')}/></TouchableOpacity>
                 <TouchableOpacity><Image style={styles.logo} source={require('./Images/s3.jpg')}/></TouchableOpacity>
                 <TouchableOpacity><Image style={styles.logo} source={require('./Images/s4.jpg')}/></TouchableOpacity>
                 <TouchableOpacity><Image style={styles.logo} source={require('./Images/s5.jpg')}/></TouchableOpacity>
                 <TouchableOpacity><Image style={styles.logo} source={require('./Images/s6.jpg')}/></TouchableOpacity>
                 <TouchableOpacity><Image style={styles.logo} source={require('./Images/s7.jpg')}/></TouchableOpacity>
                 <TouchableOpacity><Image style={styles.logo} source={require('./Images/s8.jpg')}/></TouchableOpacity>
                  ...
                  <MapView style={styles.map} provider={MapView.PROVIDER_GOOGLE}  initialRegion={{
                    ...
                    <Marker coordinate={{ latitude: 45.2584, longitude: 17.3791 }} />
                </MapView>
