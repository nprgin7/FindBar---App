...
export default class R2Screen extends React.Component {
    ...
    render() {  
        return (
            ...
            <SafeAreaView style={styles.container}>
              <ScrollView>
                  <Text style = {styles.ime}> Slavonski biser </Text>
                  <Text style = {styles.podnaslov}> restoran </Text>
                 <ScrollView style={styles.bot} horizontal={true}>
                 <TouchableOpacity><Image style={styles.logo} source={require('./Images/b1.jpg')}/></TouchableOpacity>
                 <TouchableOpacity><Image style={styles.logo} source={require('./Images/b2.jpg')}/></TouchableOpacity>
                 <TouchableOpacity><Image style={styles.logo} source={require('./Images/b3.jpg')}/></TouchableOpacity>
                 <TouchableOpacity><Image style={styles.logo} source={require('./Images/b4.jpg')}/></TouchableOpacity>
                 <TouchableOpacity><Image style={styles.logo} source={require('./Images/b5.jpg')}/></TouchableOpacity>
                 <TouchableOpacity><Image style={styles.logo} source={require('./Images/b6.jpg')}/></TouchableOpacity>
                 <TouchableOpacity><Image style={styles.logo} source={require('./Images/b7.jpg')}/></TouchableOpacity>
                 <TouchableOpacity><Image style={styles.logo} source={require('./Images/b8.jpg')}/></TouchableOpacity>
                  ...
                  <MapView style={styles.map} provider={MapView.PROVIDER_GOOGLE}  initialRegion={{
                    ...
                    <Marker coordinate={{ latitude: 45.2554, longitude: 17.3795 }} />
                </MapView>
